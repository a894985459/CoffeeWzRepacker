...
- 🟢 Compatibility issues in the World Map Editor with certain WZ versions  
- 🟢 Spot nodes in the World Map Editor cannot correctly resolve image resources across files  
...
- 🟢 世界地圖編輯器在部分 WZ 版本中存在相容性問題  
- 🟢 世界地圖編輯器中 Spot 節點無法正確跨檔案取得圖片資源
